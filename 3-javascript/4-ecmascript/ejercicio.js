    ...
    class ListaNumeros {
        ...
        numerosMayoresAMedia() {
            ...
            */
            ...
            // Filtrar números mayores que la media
            const numerosMayores = this.numeros.filter(num => num > media);
        ...
        ordenamientoMayorAMenor() {
            /*
                ...
                Investiga más sobre el funcionamiento de los parámetros (a,b) de sort para lograr 
